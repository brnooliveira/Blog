...
CREATE TABLE [Post] (
    ...
    [LastUpdateDate] SMALLDATETIME NOT NULL DEFAULT '2022-12-08T21:27:43.1049289Z',
    [CategoryId] int NULL,
    [AuthorId] int NULL,
...
VALUES (N'20221208212743_InitialCreation', N'6.0.0');
GO
...
ALTER TABLE [Post] ADD DEFAULT '2022-12-08T21:34:25.0466562Z' FOR [LastUpdateDate];
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20221208213425_AddGithubField', N'6.0.0');
GO
